...
CREATE TABLE [Post] (
    ...
    [LastUpdateDate] SMALLDATETIME NOT NULL DEFAULT '2023-06-26T19:26:34.1091966Z',
    [CategoryId] int NULL,
    [AuthorId] int NULL,
    CONSTRAINT [PK_Post] PRIMARY KEY ([Id]),
    CONSTRAINT [FK_Post_Category_CategoryId] FOREIGN KEY ([CategoryId]) REFERENCES [Category] ([Id]),
    CONSTRAINT [FK_Post_User_AuthorId] FOREIGN KEY ([AuthorId]) REFERENCES [User] ([Id])
);
GO
...
VALUES (N'20230626192634_InitialCreation', N'7.0.8');
GO
